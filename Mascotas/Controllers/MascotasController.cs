...
namespace Mascotas.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nombre,edad,sexo,tamanio,raza,tipo")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nombre,edad,sexo,tamanio,raza,tipo")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
